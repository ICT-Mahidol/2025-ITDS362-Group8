...
### 1.3 Soak Test
*(การรันโหลดต่อเนื่องเป็นเวลา 13 นาที เพื่อดูความเสถียรและ Memory Leak)*
* **duration :** 13m 06.3s
* **iterations :** 143
* **vus :** 1 (min) - 10 (max)
...
**คำตอบ: ระบบเริ่มเกิดปัญหาเสถียรภาพ (Fail) ที่จำนวนประมาณ 10 Virtual Users (VUs)**
...
**วิเคราะห์:**
* **During Spike:** เมื่อ User เพิ่มจาก 5 เป็น 25 คน ทันที ระบบไม่สามารถตอบสนองได้ตามปกติ (Fail 32.47%) และค่า Latency พุ่งชนเพดาน Timeout (60s)
